...
const DEFAULT_HERO = {
  badge: 'Authentic Italian Cuisine',
  title: 'Experience the finest',
  titleHighlight: 'Italian dining',
  description:
    'Indulge in authentic Italian flavors crafted with passion and tradition. From handmade pasta to wood-fired pizzas, every dish tells a story of culinary excellence.',
  features: [
