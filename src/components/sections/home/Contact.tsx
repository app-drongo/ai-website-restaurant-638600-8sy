...
const DEFAULT_CONTACT = {
  ...
  mainTitleHighlight: 'Perfect Evening',
  mainDescription:
    'Ready to experience exceptional Italian cuisine? Make a reservation or contact us for special events, private dining, and catering services.',
  formTitle: 'Make a Reservation',
  formDescription:
    "Book your table or send us a message. We'll confirm your reservation within 2 hours.",
  submitButton: 'Send Reservation Request',
  contactSectionTitle: 'Contact Bella Vista',
  method1Title: 'Email Us',
  method1Description: 'Reservations & inquiries',
  method1Contact: 'reservations@bellavista.com',
  method2Title: 'Call Us',
  method2Description: 'Speak with our host',
  method2Contact: '+1 (555) BELLA-01',
  method3Title: 'Walk-ins Welcome',
  method3Description: 'Subject to availability',
  method3Contact: 'First come, first served',
  officesSectionTitle: 'Our Location',
  office1City: 'Main Dining Room',
  office1Address: '123 Culinary Boulevard, Downtown',
  office1Timezone: 'EST (UTC-5)',
  office2City: 'Private Events',
  office2Address: 'Upper Level - Exclusive Dining',
  office2Timezone: 'EST (UTC-5)',
  office3City: 'Outdoor Terrace',
  office3Address: 'Garden Level - Seasonal',
  office3Timezone: 'EST (UTC-5)',
  hoursTitle: 'Restaurant Hours',
  hoursWeekdayLabel: 'Tuesday - Thursday',
  ...
  supportNote: 'Private event coordination available 7 days a week',
  nameLabel: 'Full Name *',
  namePlaceholder: 'Your Name',
  emailLabel: 'Email Address *',
  emailPlaceholder: 'your.email@example.com',
  companyLabel: 'Special Occasion (Optional)',
  companyPlaceholder: 'Anniversary, Birthday, Business Dinner...',
  messageLabel: 'Reservation Details *',
  messagePlaceholder:
    'Please include preferred date, time, party size, and any special requests...',
} as const;
