...
const DEFAULT_FOOTER = {
  ...
  companyDescription:
    'Experience authentic Italian cuisine crafted with passion and the finest ingredients. From traditional recipes passed down through generations to modern culinary innovations, we create memorable dining experiences in the heart of the city.',
  contactEmail: 'info@bellavista.com',
  contactPhone: '+1 (555) 234-FOOD',
  contactAddress: '456 Culinary Lane, Downtown District',
  newsletterTitle: 'Taste Updates',
  newsletterPlaceholder: 'Enter your email for specials',
  newsletterDisclaimer:
    'Get exclusive offers, seasonal menus, and event invitations. No spam, unsubscribe anytime.',
  section1Title: 'Menu',
  ...
  socialText: 'Follow our culinary journey:',
